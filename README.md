...
- 🛠️ Building a **PDF Tools App** (merge, split, convert PDFs)  
- ☁️ Exploring **deployment & cloud hosting**  
...
## 📂 Featured Projects
- 🌦️ [Weather App](https://cloudleaf.netlify.app/) – Simple weather forecast app using OpenWeather API   
